...
async function getOverdueRows(limit: number, companyId: string): Promise<Outstanding[]> {
  ...
  query.searchParams.set("select", "company_id,customer_name,customer_number,invoicenumber,date,duedate,overdue_days,amount,closing_balance,voucher_type");
...
export default async function OverduePage({ searchParams }: { searchParams: { limit?: string; access?: string } }) {
